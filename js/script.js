...
$(document).ready(function(){
    ...
    function updateSectionClass() {
        ...
        $('.se1').toggleClass('on', scrollValue >= 0 && scrollValue < 880);
        $('.se2').toggleClass('on', scrollValue >= 880 && scrollValue < 1960);
        $('.se3').toggleClass('on', scrollValue >= 1960 && scrollValue < 3040);
        $('.se4').toggleClass('on', scrollValue >= 3040 && scrollValue < 4160);
    }
